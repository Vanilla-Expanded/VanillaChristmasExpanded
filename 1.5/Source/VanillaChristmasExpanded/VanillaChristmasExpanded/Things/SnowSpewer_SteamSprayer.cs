...
{
    public class SnowSpewer_SteamSprayer
    {
        ...
        public SnowSpewer_SteamSprayer(Thing parent)
        {
            this.parent = parent;
        }
        ...
        public void SteamSprayerTick()
        {
            if (sprayTicksLeft > 0)
            {
                ...
                {
                    Utils.ThrowExtendedAirPuffUp(parent.TrueCenter() + new Vector3(0, 0, 2.75f), parent.Map, 2, 2);
                }
