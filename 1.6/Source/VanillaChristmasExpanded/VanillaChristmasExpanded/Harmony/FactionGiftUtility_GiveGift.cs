...
namespace VanillaChristmasExpanded
{
    ...
    [HarmonyPatch(typeof(FactionGiftUtility), "GiveGift", new Type[] { typeof(List<ActiveTransporterInfo>), typeof(Settlement) })]
    public static class VanillaChristmasExpanded_FactionGiftUtility_GiveGift_DropPods_Patch
    {
        ...
        public static void Prefix(List<ActiveTransporterInfo> pods, Settlement giveTo)
        {
            ...
            float totalGifts = 0;
            float totalFestive = 0;
            foreach (ActiveTransporterInfo podInfo in pods)
            {
